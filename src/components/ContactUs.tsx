  ...
  return (
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
        ...
        aria-hidden="true"
      >
        {/* ... (rest of the background gradient div) ... */}
      </div>
...
<div>
            <label htmlFor="first-name" class="block text-sm font-semibold leading-6 text-gray-900">
              First name
            </label>
            <div class="mt-2.5">
              <input
          ...
          <div>
            <label htmlFor="last-name" class="block text-sm font-semibold leading-6 text-gray-900">
              Last name
            </label>
            <div class="mt-2.5">
              <input
          ...
          <div class="sm:col-span-2">
            <label htmlFor="company" class="block text-sm font-semibold leading-6 text-gray-900">
              Company
            </label>
            <div class="mt-2.5">
              <input
          ...
          <div class="sm:col-span-2">
            <label htmlFor="email" class="block text-sm font-semibold leading-6 text-gray-900">
              Email
            </label>
            <div class="mt-2.5">
              <input
          ...
          <div class="sm:col-span-2">
            <label htmlFor="phone-number" class="block text-sm font-semibold leading-6 text-gray-900">
              Phone number
            </label>
          ...
          <div class="sm:col-span-2">
            <label htmlFor="message" class="block text-sm font-semibold leading-6 text-gray-900">
              Message
            </label>
            <div class="mt-2.5">
              <textarea
          ...
          <div class="sm:col-span-2">
            <Switch checked={agreed()} onChange={e => setAgreed(e.target.checked)} class={classNames(
